  ...
  methods: {
    fetchData(seq) {
      fetchChannelInfo(seq).then(response => {
        ...
        this.alipay_is_ok = response.data.channel.alipay.is_ok
        this.alipay_timelines = response.data.channel.alipay.history

        this.wxpay_is_ok = response.data.channel.wxpay.is_ok
