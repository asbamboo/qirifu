...
class CommonParams implements CommonParamsInterface
{
    ...
    {
        $this->app_id       = \Parameter::instance()->get('ALIPAY_APPID');
        $this->format       = 'JSON';
        $this->charset      = 'UTF-8';
     ...
     *
     * {@inheritDoc}
     * @see \asbamboo\qirifu\common\alipay\requestParams\CommonParamsInterface::setBizContent()
     */
     ...
     *
     * {@inheritDoc}
     * @see \asbamboo\qirifu\common\alipay\requestParams\CommonParamsInterface::makeSign()
     */
    public function makeSign() : string
    {
        $sign           = '';
        $sign_str       = $this->getSignString();
        $private_pem    = \Parameter::instance()->get('ALIPAY_RSA_PRIVATE_KEY');
        ...
        throw new SystemException('无法生成签名。pem:' . $private_pem);
    }
